...
A personal machine learning project for analyzing horse racing data.

This project focuses on prediction and analysis using features such as race conditions, running styles, distance suitability, track condition, pace, passing order, and race development.
...
I recently started working on Kaggle competitions to strengthen my practical machine learning skills.

I am currently focusing on learning the basic workflow of machine learning projects, including data preprocessing, feature engineering, model training, evaluation, and submission generation.
...
I value the following process when building software and data-driven systems:
...
I believe AI and data analysis become valuable when they are connected to real problems and implemented as useful software.
...
My goal is to become a software engineer who can design, implement, and improve AI-powered systems that solve real-world problems.

I want to contribute to products used by many people and continuously improve user experience through data, AI, and software engineering.

---

## Links

- GitHub: https://github.com/tomoki0903
- Kaggle: https://www.kaggle.com/tomokiiso
